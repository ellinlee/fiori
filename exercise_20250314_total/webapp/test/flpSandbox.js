		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[D17] 총정리",
									"targetURL": "#exercise20250314total-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exercise20250314total-display": {
								"semanticObject": "exercise20250314total",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exercise20250314total",
									"url": sap.ui.require.toUrl("exercise20250314total")
								}
							}
						}
					}
