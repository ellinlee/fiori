		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "멘토링 0311",
									"targetURL": "#mentoring0311-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentoring0311-display": {
								"semanticObject": "mentoring0311",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentoring0311",
									"url": sap.ui.require.toUrl("mentoring0311")
								}
							}
						}
					}
